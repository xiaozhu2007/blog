  ...
  return (function (t) {
    ...
    function (t, e, n) {
      (function (t, n) {
        ...
        !(function () {
          ...
          void 0 === e || e.nodeType
            ? (s._ = m)
            : (void 0 !== n && !n.nodeType && n.exports && (e = n.exports = m),
              (e._ = m)),
            (m.VERSION = "1.9.1");
          var g,
            b = function (t, e, n) {
          ...
          (m.reduce = m.foldl = m.inject = x(1)),
            ...
            (m.every = m.all =
              function (t, e, n) {
                e = w(e, n);
                for (
                  var r = !j(t) && m.keys(t), i = (r || t).length, s = 0;
                  s < i;
                  s++
                ) {
                  var o = r ? r[s] : s;
            ...
            (m.sample = function (t, e, n) {
              if (null == e || n)
                return j(t) || (t = m.values(t)), t[m.random(t.length - 1)];
          ...
          var I = function (t, e, n, r) {
            ...
            for (var i = r.length, s = 0, o = N(t); s < o; s++) {
              ...
              if (j(a) && (m.isArray(a) || m.isArguments(a)))
                if (e) for (var u = 0, c = a.length; u < c; ) r[i++] = a[u++];
          ...
          (m.flatten = function (t, e) {
              ...
              function (t, e, n, r) {
                ...
                for (var i = [], s = [], o = 0, a = N(t); o < a; o++) {
                  ...
                  e && !n
                    ? ((o && s === c) || i.push(u), (s = c))
                    : n
                    ? m.contains(s, c) || (s.push(c), i.push(u))
            ...
            (m.intersection = function (t) {
              for (
                var e = [], n = arguments.length, r = 0, i = N(t);
                r < i;
                r++
              ) {
                var s = t[r];
            ...
            (m.unzip = function (t) {
              for (
                var e = (t && m.max(t, N).length) || 0, n = Array(e), r = 0;
                r < e;
                r++
              )
                n[r] = m.pluck(t, r);
          ...
          var D = function (t, e, n) {
            return function (r, i, s) {
              ...
              if (i !== i)
                return (s = e(h.call(r, o, a), m.isNaN)), s >= 0 ? s + o : -1;
          ...
          var L = !{ toString: null }.propertyIsEnumerable("toString"),
            ...
            q = function (t, e) {
              var n = F.length,
                ...
                s = "constructor";
              for (C(t, s) && !m.contains(e, s) && e.push(s); n--; )
                (s = F[n]) in t &&
                  t[s] !== i[s] &&
                  !m.contains(e, s) &&
                  e.push(s);
          ...
          (B = function (t, e, n, r) {
            ...
            (J = function (t, e, n, r) {
              ...
              if ((n.push(t), r.push(e), s)) {
                ...
                for (; u--; )
                  if (((l = h[u]), !C(e, l) || !B(t[l], e[l], n, r))) return !1;
              }
            ...
            (m.isEmpty = function (t) {
              return (
                null == t ||
                (j(t) && (m.isArray(t) || m.isString(t) || m.isArguments(t))
                  ? 0 === t.length
                  : 0 === m.keys(t).length)
              );
            }),
    ...
    function (t, e, n) {
      ...
      var r = n(0),
        ...
        y = function (t, e, n, r, i, s, a) {
          ...
          return (
            r && "get" === r.toLowerCase() && ((a = o({}, a, i)), (i = null)),
            v({ method: r, path: u, query: a, data: i, authOptions: s })
          );
        };
    ...
    function (t, e, n) {
      ...
      var r =
        ...
        h = function (t) {
          ...
          var g = l++;
          return (
            a("request(%d) %s %s %o %o %o", g, e, n, v, h, d),
            new c(function (t, r) {
              ...
              p && c.on("progress", p),
                ...
                c.end(function (s, c) {
                  return s
                    ? (c &&
                        (o.enabled("leancloud:request") ||
                          u("request(%d) %s %s %o %o %o", g, e, n, i, h, d),
                        u(
                          "response(%d) %d %O %o",
                          g,
                          c.status,
        ...
        w = function (t, e) {
          for (
            var n = e.split("."), r = n[0], i = n.pop(), s = t, o = 0;
            o < n.length;
            o++
          )
    ...
    function (t, e, n) {
      ...
      (function (e) {
        ...
        (h._config = {
          ...
          (h._sharedConfig = { userAgent: o, liveQueryRealtime: null }),
          ...
          (h._getInstallationId = function () {
            ...
            return h.localStorage.getItemAsync(t).then(function (e) {
              return (
                ...
                h._installationId
                  ? e
                  : ((h._installationId = e = i()),
                    h.localStorage.setItemAsync(t, e).then(function () {
                      return e;
                    }))
              );
            });
          ...
          (h._getSubscriptionId = function () {
            ...
            return h.localStorage.getItemAsync(t).then(function (e) {
              return (
                (h._subscriptionId = e),
                h._subscriptionId || (e = h._refreshSubscriptionId(t)),
                e
              );
            });
          }),
      ...
      (m.serializeObject = i),
        ...
        (c.prototype._parseBody = function (t) {
          ...
          return this.req._parser
            ...
            : (!e && u(this.type) && (e = m.parse["application/json"]),
        ...
        (l.prototype._end = function () {
          ...
          if (
            ...
            !s && u(i) && (s = m.serialize["application/json"]),
              s && (n = s(n));
          }
    ...
    function (t, e, n) {
      ...
      (i.init = function (t) {
        ...
        if (
          (i._setServerURLs(
            c({}, r(e), i._config.serverURLs, "string" == typeof a ? h(a) : a),
            _
          ),
          p)
        )
        ...
        (t.File = function (e, i, s) {
          ...
          r.extend(t.File.prototype, {
            ...
            _fileToken: function (t, r) {
              ...
              !s &&
                this._extName &&
                ((i += this._extName), (s = this._extName));
              var o = e() + e() + e() + e() + e() + s,
                a = {
                  key: o,
                  name: i,
              ...
              return (
                (this._qiniu_key = o), u("fileTokens", null, null, "POST", a, r)
              );
            },
            save: function () {
              var t = this,
              ...
              if (!this._previousSave)
                if (this._data) {
                  ...
                  this._previousSave = this._fileToken(n, e).then(function (a) {
                    return (
                      a.mime_type && ((n = a.mime_type), t.set("mime_type", n)),
                      (t._token = a.token),
                      c
                        .resolve()
                        .then(function () {
      ...
      t.exports = function (t, e, n) {
        ...
        return new s(function (t, s) {
          var u = r("POST", a)
            ...
            .attach("fileContent", e, n.attributes.name)
            .field("op", "upload");
    ...
    function (t, e, n) {
      ...
      t.exports = function (t, e, n) {
        ...
        return new i(function (i, c) {
          var l = r("POST", u)
            .set(n._uploadHeaders)
            .attach("file", e, n.attributes.name)
            .field("name", n.attributes.name)
            .field("key", t.key || n._qiniu_key)
            .field("token", a);
          o.onprogress && l.on("progress", o.onprogress),
            l.end(function (t, e) {
              if ((e && s(e.status, e.body, e.text), t))
                return (
                  e &&
        ...
        var e = n(45),
          ...
          o = function (t, n) {
            ...
            (a[u >>> 5] |= 128 << u % 32),
              (a[14 + (((u + 64) >>> 9) << 4)] = u);
            for (
              var p = o._ff, _ = o._gg, v = o._hh, y = o._ii, d = 0;
              d < a.length;
              d += 16
            ) {
              var m = c,
              ...
              (c = p(c, l, h, f, a[d + 0], 7, -680876936)),
                ...
                (c = y(c, l, h, f, a[d + 0], 6, -198630844)),
                (f = y(f, c, l, h, a[d + 7], 10, 1126891415)),
                (h = y(h, f, c, l, a[d + 14], 15, -1416354905)),
                (l = y(l, h, f, c, a[d + 5], 21, -57434055)),
                (c = y(c, l, h, f, a[d + 12], 6, 1700485571)),
                (f = y(f, c, l, h, a[d + 3], 10, -1894986606)),
                (h = y(h, f, c, l, a[d + 10], 15, -1051523)),
                (l = y(l, h, f, c, a[d + 1], 21, -2054922799)),
                (c = y(c, l, h, f, a[d + 8], 6, 1873313359)),
                (f = y(f, c, l, h, a[d + 15], 10, -30611744)),
                (h = y(h, f, c, l, a[d + 6], 15, -1560198380)),
                (l = y(l, h, f, c, a[d + 13], 21, 1309151649)),
                (c = y(c, l, h, f, a[d + 4], 6, -145523070)),
                (f = y(f, c, l, h, a[d + 11], 10, -1120210379)),
                (h = y(h, f, c, l, a[d + 2], 15, 718787259)),
                (l = y(l, h, f, c, a[d + 9], 21, -343485551)),
                (c = (c + m) >>> 0),
                (l = (l + g) >>> 0),
                (h = (h + b) >>> 0),
                (f = (f + w) >>> 0);
      ...
      t.exports = function (t) {
        (t.Object = function (e, n) {
              ...
              .then(function (e) {
                var n = s.map(t, function (t, n) {
                  ...
                  return null === e[n].success
                    ? new o(o.OBJECT_NOT_FOUND, "Object not found.")
                    : new o(e[n].error.code, e[n].error.error);
                });
                return b(n);
              });
          }),
          s.extend(t.Object.prototype, t.Events, {
            ...
            _toFullJSON: function (e) {
              ...
              return (
                ...
                s.has(this, "id") && (i.objectId = this.id),
                s(["createdAt", "updatedAt"]).each(function (t) {
                  if (s.has(n, t)) {
                    var e = n[t];
                ...
                r &&
                  ((i.__type = "Object"),
                  s.isArray(e) && e.length && (i.__type = "Pointer"),
            ...
            _applyOpSet: function (e, n) {
              ...
              t._objectEach(e, function (e, s) {
                var o = _(n, s),
                  ...
                  c = a[1],
                  l = a[2];
                p(n, s, e._estimate(u, r, s)),
                  c && c[l] === t.Op._UNSET && delete c[l];
              });
            },
                ...
                t._arrayEach(this._opSetQueue, function (r) {
                  ...
                  if (s) {
                    var o = _(n.attributes, e),
                      ...
                      l = a[2],
                      h = a[3];
                    p(n.attributes, e, s._estimate(u, n, e)),
                      c && c[l] === t.Op._UNSET && delete c[l],
            ...
            _rebuildAllEstimatedData: function () {
              ...
              (this.attributes = s.clone(this._serverData)),
            ...
            set: function (e, n, r) {
              ...
              if (
                (s.isObject(e) || h(e)
                  ? ((i = s.mapObject(e, function (e, n) {
                      return g(n), t._decode(e, n);
                    })),
                    (r = n))
                  : ((i = {}), g(e), (i[e] = t._decode(n, e))),
                (r = r || {}),
                !i)
              )
                return this;
            ...
            increment: function (e, n) {
              return (
                (s.isUndefined(n) || s.isNull(n)) && (n = 1),
            ...
            revert: function (t) {
              var e = s.last(this._opSetQueue);
              return (
                f(t || s.keys(e)).forEach(function (t) {
                  delete e[t];
                }),
                this._rebuildAllEstimatedData(),
                this
            ...
            fetch: function () {
              var t =
                ...
                e = arguments[1],
                n = this;
              return c("classes", this.className, this.id, "GET", d(t), e).then(
                function (e) {
                  var r = n.parse(e);
                  return (
                    t.keys || n._cleanupUnsetKeys(r), n._finishFetch(r, !0), n
                  );
                }
              );
            },
            ...
            save: function (e, n, r) {
              ...
              s.isObject(e) || h(e)
                ...
                : ((i = {}), (i[e] = n), (u = r)),
                (u = s.clone(u) || {}),
                u.wait && (o = s.clone(this.attributes));
              var l = s.clone(u) || {};
              ...
              var f = this,
                ...
                p = [];
              return (
                t.Object._findUnsavedChildren(f, d, p),
                d.length + p.length > 1
                  ? t.Object._deepSaveAsync(this, f, u)
                  : (this._startSave(),
                      ...
                      .then(function () {
                        ...
                        if (
                          ((f._fetchWhenSave || u.fetchWhenSave) &&
                            (n.new = "true"),
                          u._failOnNotExist && (n.failOnNotExist = "true"),
                          u.query)
                        ) {
                          var r;
                          if (
            ...
            parse: function (e) {
              var n = s.clone(e);
              return (
                s(["createdAt", "updatedAt"]).each(function (e) {
            ...
            change: function (e) {
              ...
              for (
                ...
                (this._pending = {}),
                  ...
                  (r._previousAttributes = s.clone(this.attributes));
              return (this._changing = !1), this;
            },
            hasChanged: function (t) {
              return arguments.length
                ? this.changed && s.has(this.changed, t)
            ...
            validate: function (e) {
              if (s.has(e, "ACL") && !(e.ACL instanceof t.ACL))
                throw new o(o.OTHER_CAUSE, "ACL must be a AV.ACL.");
            },
            _validate: function (t, e) {
              !e.silent &&
                this.validate &&
                ((t = s.extend({}, this.attributes, t)), this.validate(t));
            },
            getACL: function () {
              return this.get("ACL");
            },
          ...
          (t.Object.extend = function (e, n, r) {
            ...
            return (
              (i.extend = function (n) {
                if (s.isString(n) || (n && s.has(n, "className")))
              ...
              Object.defineProperty(
                i,
                "query",
                Object.getOwnPropertyDescriptor(t.Object, "query")
              ),
              (i.new = function (t, e) {
                return new i(t, e);
              }),
                        ...
                        return c(
                          ...
                          var n = s.map(e, function (e, n) {
                            return t[n].success
                              ...
                              : (e._cancelSave(),
                                new o(t[n].error.code, t[n].error.error));
                          });
                          return b(n);
                        });
                      });
      ...
      var i = n(0),
        ...
        d = function (t, e) {
          var n =
            ...
            u = void 0 !== a && a;
          if ("string" != typeof e)
            throw new o(o.OTHER_CAUSE, "unionId is not a string");
          if ("string" != typeof s)
            throw new o(o.OTHER_CAUSE, "unionIdPlatform is not a string");
          return i.extend({}, t, {
            platform: s,
            unionid: e,
        ...
        t.User = t.Object.extend(
          "_User",
          {
            ...
            _handleSaveResult: function (e) {
              return (
                ...
                (!e && !this.isCurrent()) || t._config.disableCurrentUser
                  ? l.resolve()
                  : l.resolve(t.User._saveCurrentUser(this))
              );
            },
            ...
            _isLinked: function (t) {
              var e;
              return (
                (e = i.isString(t) ? t : t.getAuthType()),
                !!(this.get("authData") || {})[e]
              );
            },
            ...
            _logOutWith: function (e) {
              this.isCurrent() &&
                (i.isString(e) && (e = t.User._authProviders[e]),
            ...
            signUp: function (t, e) {
              ...
              return this.save(t, e).then(function (t) {
                return (
                  t.isAnonymous() &&
                    (t.unset("authData.anonymous"), (t._opSetQueue = [{}])),
            ...
            save: function (e, n, r) {
              var s, o;
              return (
                i.isObject(e) || i.isNull(e) || i.isUndefined(e)
                  ? ((s = e), (o = n))
                  : ((s = {}), (s[e] = n), (o = r)),
                (o = o || {}),
          ...
          },
          {
            ...
            requestMobilePhoneVerify: function (t) {
              ...
              return (
                ...
                u("requestMobilePhoneVerify", null, null, "POST", n, e)
              );
            },
            requestPasswordResetBySmsCode: function (t) {
              ...
              return (
                e.validateToken && (n.validate_token = e.validateToken),
                u("requestPasswordResetBySmsCode", null, null, "POST", n, e)
              );
            },
            ...
            requestLoginSmsCode: function (t) {
              ...
              return (
                e.validateToken && (n.validate_token = e.validateToken),
                u("requestLoginSmsCode", null, null, "POST", n, e)
              );
            },
            ...
            _saveCurrentUser: function (e) {
              var n;
              return (
                (n = t.User._currentUser !== e ? t.User.logOut() : l.resolve()),
                n.then(function () {
        ...
        (t.Query = function (e) {
          ...
          r.extend(t.Query.prototype, {
            ...
            get: function (t, e) {
              ...
              if ("" === t)
                return s.reject(new o(o.OBJECT_NOT_FOUND, "Object not found."));
              ...
              return (
                ...
                u("classes", this.className, t, "GET", f(a), e).then(function (
                  t
                ) {
                  if (r.isEmpty(t))
            ...
            _createRequest: function () {
              ...
              if (encodeURIComponent(JSON.stringify(t)).length > 2e3) {
                return c({
                  ...
                  method: "POST",
                  data: {
                    requests: [{ method: "GET", path: "/1.1" + n, params: t }],
                  },
                  authOptions: e,
                }).then(function (t) {
                  var e = t[0];
            ...
            skip: function (t) {
              return (
                d(t, "undefined is not a valid skip value"),
                (this._skip = t),
                this
              );
            },
            limit: function (t) {
              return (
                d(t, "undefined is not a valid limit value"),
                (this._limit = t),
                this
              );
            },
            ...
            _addCondition: function (e, n, r) {
              return (
                d(e, "undefined is not a valid condition key"),
            ...
            ascending: function (t) {
              return (
                d(t, "undefined is not a valid key"), (this._order = t), this
              );
            },
                ...
                function () {
                  return o.find(n).then(function (t) {
                    ...
                    return (
                      ...
                      n.then(function () {
                        t.length >= o._limit
                          ? o.greaterThan("objectId", t[t.length - 1].id)
                          : (a = !0);
                      })
                    );
                  });
      ...
      t.exports = function (t) {
        var e = function () {
            var e =
              arguments.length > 0 && void 0 !== arguments[0]
                ...
                : {};
            return u(e)
              ? t.User._fetchUserBySessionToken(u(e))
              : t.User.currentAsync();
          },
          n = function (n) {
        ...
        (t.Status = function (t, e) {
          ...
          i.extend(t.Status.prototype, {
            ...
            destroy: function (t) {
              return this.id
                ? o("statuses", null, this.id, "DELETE", t)
                : s.reject(new Error("The status id is not exists."));
            },
            toObject: function () {
              return this.id
          ...
          (t.Status.sendStatusToFollowers = function (e) {
            ...
            return n(r).then(function (n) {
              ...
              return (
                ...
                (s.inboxType = e.inboxType || "default"),
                o("statuses", null, null, "POST", s, r).then(function (n) {
                  return (
                    (e.id = n.objectId),
                    (e.createdAt = t._parseDate(n.createdAt)),
                    e
          ...
          (t.Status.sendPrivateStatus = function (e, r) {
            ...
            return n(s).then(function (n) {
              ...
              return (
                ...
                (i.inboxType = "private"),
                (e.inboxType = "private"),
                o("statuses", null, null, "POST", i, s).then(function (n) {
                  return (
                    (e.id = n.objectId),
                    (e.createdAt = t._parseDate(n.createdAt)),
                    e
          ...
          (t.Status.countUnreadStatuses = function (n) {
            ...
            return s.resolve(n || e(a)).then(function (e) {
              ...
              return (
                ...
                (n.owner = t._encode(e)),
                o("subscribe/statuses/count", null, null, "GET", n, a)
              );
            });
          }),
        ...
        i.extend(d.prototype, {
          ...
          getResultsAroundUser: function (t) {
            ...
            var r = e.limit,
              ...
              o = e.version;
            return this._getResults(
              { limit: r, selectUserKeys: i, includeStatistics: s, version: o },
              n,
              t ? t.id : "self"
            );
          },
