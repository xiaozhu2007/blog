var Gitment = (function (a) {
  ...
  function (a, b) {
    ...
    Object.defineProperty(b, "__esModule", { value: !0 }),
      (b.LS_ACCESS_TOKEN_KEY = "gitment-comments-token"),
      (b.LS_USER_KEY = "gitment-user-info"),
      (b.NOT_INITIALIZED_ERROR = new Error("Comments Not Initialized"));
  },
  function (a, b, c) {
    "use strict";
    !function (c) {
      function i(a) {
        return function (b, c, d) {
          return d && "function" == typeof d.value
            ? ((d.value = _(a, d.value)),
              (d.enumerable = !1),
              (d.configurable = !0),
              d)
      ...
      function j(a, b, c) {
        ...
        return (
          vd("function" == typeof e, qd("m002")),
          vd(0 === e.length, qd("m003")),
          vd(
            "string" == typeof d && d.length > 0,
            "actions should have valid names, got: '" + d + "'"
          ),
          ab(d, e, f, void 0)
        );
      }
      ...
      function m(a, b, c) {
        ...
        return (
          "string" == typeof a
            ? ((d = a), (e = b), (f = c))
            : ((d = a.name || "Autorun@" + td()), (e = a), (f = b)),
          vd("function" == typeof e, qd("m004")),
          vd(k(e) === !1, qd("m005")),
          f && (e = e.bind(f)),
          (g = new Ub(d, function () {
            this.track(h);
      ...
      function p(a, b, c) {
        ...
        var e, f, g, i, j;
        return (
          arguments.length > 3 && ud(qd("m007")),
          rc(a) && ud(qd("m008")),
          (e =
            "object" === ("undefined" == typeof c ? "undefined" : d(c))
              ? c
              : {}),
          (e.name = e.name || a.name || b.name || "Reaction@" + td()),
          (e.fireImmediately = c === !0 || e.fireImmediately === !0),
          (e.delay = e.delay || 0),
          (e.compareStructural = e.compareStructural || e.struct || !1),
          (b = h(e.name, e.context ? b.bind(e.context) : b)),
          e.context && (a = a.bind(e.context)),
          (f = !0),
          (g = !1),
          (j = new Ub(e.name, function () {
            f || e.delay < 1
              ? k()
              : g ||
                ((g = !0),
      ...
      function q(a) {
        return hd(
          function (b, c, d, e, f) {
            vd("undefined" != typeof f, qd("m009")),
              vd("function" == typeof f.get, qd("m010"));
            var g = Qc(b, "");
      ...
      function u(a, b) {
        ...
        return (
          ...
          (f = (function (d) {
            ...
            return (
              e(f, d),
              (f.prototype.onBecomeUnobserved = function () {
                var a = this.value;
                d.prototype.onBecomeUnobserved.call(this),
          ...
          function (a) {
            var b, e;
            return (
              d !== Cb.resetId && ((c = {}), (d = Cb.resetId)),
              (b = v(a)),
              (e = c[b]) ? e.get() : ((e = c[b] = new f(b, a)), e.get())
            );
          }
        );
      }
      function v(a) {
        if (
          ...
          throw new Error(
            "[mobx] transform expected some kind of object, got: " + a
          );
        var b = a.$transformId;
        return void 0 === b && ((b = td()), Jd(a, "$transformId", b)), b;
      }
      function w(a, b) {
        return rb() || console.warn(qd("m013")), t(a, { context: b }).get();
      }
      function x(a) {
        var c,
          b = [];
      ...
      function B(a) {
        ...
        return (
          a.observing &&
            a.observing.length > 0 &&
            (b.dependencies = Ad(a.observing).map(B)),
          b
        );
      }
      function C(a, b) {
      ...
      function O(a) {
        if ((void 0 === a && (a = void 0), "string" == typeof arguments[1]))
          return J.apply(null, arguments);
        if (
          (vd(arguments.length <= 1, qd("m021")), vd(!rc(a), qd("m020")), I(a))
        )
          return a;
      ...
      function $(a, b) {
        ...
        return (
          (a = ed(a)),
          mb(a) ? Z(a.whyRun()) : _b(a) ? Z(a.whyRun()) : ud(qd("m025"))
        );
      }
      function _(a, b) {
        vd("function" == typeof b, qd("m026")),
          vd(
            "string" == typeof a && a.length > 0,
            "actions should have valid names, got: '" + a + "'"
          );
        var c = function () {
      ...
      function bb(a, b, c, d) {
        ...
        if (e) {
          ...
          dc({ type: "action", name: a, fn: b, object: c, arguments: h });
        }
        return (
          (j = xb()),
          Nb(),
      ...
      function cb(a) {
        hb(a.prevAllowStateChanges),
          Ob(),
          yb(a.prevDerivation),
          a.notifySpy && fc({ time: Date.now() - a.startTime });
      }
      function db(a) {
        vd(null === Cb.trackingDerivation, qd("m028")),
          (Cb.strictMode = a),
      ...
      function sb(a) {
        ...
        Cb.computationDepth > 0 && b && ud(qd("m031") + a.name),
          !Cb.allowStateChanges &&
            b &&
            ud(qd(Cb.strictMode ? "m030a" : "m030b") + a.name);
      }
      function tb(a, b, c) {
        var d, e;
        zb(a),
          (a.newObserving = new Array(a.observing.length + 100)),
          (a.unboundDepsCount = 0),
          (a.runId = ++Cb.runId),
          (d = Cb.trackingDerivation),
      ...
      function ub(a) {
        ...
        for (
          a.newObserving = null, d = 0, e = a.unboundDepsCount, f = 0;
          e > f;
          f++
        )
          (g = c[f]),
            0 === g.diffValue &&
              ((g.diffValue = 1), d !== f && (c[d] = g), d++);
        for (c.length = d, e = b.length; e--; )
          (g = b[e]), 0 === g.diffValue && Lb(g, a), (g.diffValue = 0);
        for (; d--; )
          (g = c[d]), 1 === g.diffValue && ((g.diffValue = 0), Kb(g, a));
      }
      function vb(a) {
      ...
      function zb(a) {
        ...
        if (a.dependenciesState !== nb.UP_TO_DATE)
          for (
            a.dependenciesState = nb.UP_TO_DATE, b = a.observing, c = b.length;
            c--;

          )
            b[c].lowestObserverState = nb.UP_TO_DATE;
      }
      function Db() {
        var a = sd(),
          b = Cb;
        if (a.__mobservableTrackingStack || a.__mobservableViewStack)
          throw new Error(
            "[mobx] An incompatible version of mobservable is already loaded."
          );
        if (a.__mobxGlobal && a.__mobxGlobal.version !== b.version)
          throw new Error(
      ...
      function Kb(a, b) {
        ...
        c && (a.observersIndexes[b.__mapid] = c),
          (a.observers[c] = b),
          a.lowestObserverState > b.dependenciesState &&
            (a.lowestObserverState = b.dependenciesState);
      }
      function Lb(a, b) {
        var c, d, e, f;
        1 === a.observers.length
          ? ((a.observers.length = 0), Mb(a))
          : ((c = a.observers),
            (d = a.observersIndexes),
            (e = c.pop()),
            e !== b &&
              ((f = d[b.__mapid] || 0),
              f ? (d[e.__mapid] = f) : delete d[e.__mapid],
              (c[f] = e)),
            delete d[b.__mapid]);
      }
      function Mb(a) {
        a.isPendingUnobservation ||
          ((a.isPendingUnobservation = !0), Cb.pendingUnobservations.push(a));
      }
      function Nb() {
        Cb.inBatch++;
      }
      function Ob() {
        var a, b, c;
        if (0 === --Cb.inBatch) {
          for (Zb(), a = Cb.pendingUnobservations, b = 0; b < a.length; b++)
            (c = a[b]),
              (c.isPendingUnobservation = !1),
              0 === c.observers.length && c.onBecomeUnobserved();
      ...
      function Pb(a) {
        ...
        null !== b
          ? b.runId !== a.lastAccessedBy &&
            ((a.lastAccessedBy = b.runId),
            (b.newObserving[b.unboundDepsCount++] = a))
          : 0 === a.observers.length && Mb(a);
      }
      function Rb(a) {
        var b, c, d;
        if (a.lowestObserverState !== nb.STALE)
          for (
            a.lowestObserverState = nb.STALE, b = a.observers, c = b.length;
            c--;

          )
            (d = b[c]),
              d.dependenciesState === nb.UP_TO_DATE && d.onBecomeStale(),
              (d.dependenciesState = nb.STALE);
      }
      function Sb(a) {
        var b, c, d;
        if (a.lowestObserverState !== nb.STALE)
          for (
            ...
            (d = b[c]),
              d.dependenciesState === nb.POSSIBLY_STALE
                ? (d.dependenciesState = nb.STALE)
                : d.dependenciesState === nb.UP_TO_DATE &&
                  (a.lowestObserverState = nb.UP_TO_DATE);
      }
      function Tb(a) {
        var b, c, d;
        if (a.lowestObserverState === nb.UP_TO_DATE)
          for (
            a.lowestObserverState = nb.POSSIBLY_STALE,
              b = a.observers,
              c = b.length;
            c--;
            ...
            (d = b[c]),
              d.dependenciesState === nb.UP_TO_DATE &&
                ((d.dependenciesState = nb.POSSIBLY_STALE), d.onBecomeStale());
      }
      function Vb(a) {
        vd(this && this.$mobx && _b(this.$mobx), "Invalid `this`"),
          vd(
      ...
      function Wb(a) {
        return (
          Cb.globalReactionErrorHandlers.push(a),
          function () {
      ...
      function $b() {
        var a, b, c, d, e;
        for (
          Cb.isRunningReactions = !0, a = Cb.pendingReactions, b = 0;
          a.length > 0;
      ...
      function gc(a) {
        return (
          Cb.spyListeners.push(a),
          yd(function () {
            var b = Cb.spyListeners.indexOf(a);
            -1 !== b && Cb.spyListeners.splice(b, 1);
          })
        );
      }
      function hc(a) {
      ...
      function nc(a) {
        return (
          xd("asReference is deprecated, use observable.ref instead"), Q.ref(a)
        );
      }
      function oc(a) {
        return (
      ...
      function pc(a) {
        return (
          xd("asFlat is deprecated, use observable.shallow instead"),
          Q.shallow(a)
        );
      }
      function qc(a) {
      ...
      function rc(a) {
        return (
          "object" === ("undefined" == typeof a ? "undefined" : d(a)) &&
          null !== a &&
          a.isMobxModifierDescriptor === !0
        );
      }
      function sc(a, b) {
        return (
          vd(!rc(b), "Modifiers cannot be nested"),
          { isMobxModifierDescriptor: !0, initialValue: b, enhancer: a }
        );
      }
      function tc(a, b, c) {
        return (
      ...
      function Gc(a) {
        return function (b) {
          ...
          if (a < d.length) {
            ...
            (b = c.enhancer(b, e)),
              (g = b !== e),
              g && ((d[a] = b), c.notifyArrayChildUpdate(a, b, e));
          } else {
            if (a !== d.length)
              throw new Error(
        ...
        return function () {
          ...
          if (b) {
            if (a < b.values.length)
              return b.atom.reportObserved(), b.values[a];
            console.warn(
      ...
      function Qc(a, b) {
        ...
        vd(Object.isExtensible(a), qd("m035")),
          Dd(a) ||
            (b = (a.constructor.name || "ObservableObject") + "@" + td()),
          b || (b = "ObservableObject@" + td());
        var c = new Pc(a, b);
      ...
      function Rc(a, b, c, d) {
        ...
        if ("value" in c)
          if (rc(c.value)) {
            ...
            k(c.value) && c.value.autoBind === !0
              ? l(a.target, b, c.value.originalFn)
              : mb(c.value)
              ? Uc(a, b, c.value)
              : Sc(a, b, c.value, d);
      ...
      function Sc(a, b, c, d) {
        ...
        (f = a.values[b] = new cd(c, d, a.name + "." + b, !1)),
          (c = f.value),
          Object.defineProperty(a.target, b, Xc(b)),
          $c(a, a.target, b, c);
      }
      function Tc(a, b, c, d, e, f) {
        f && Md(a.target, b),
          (a.values[b] = new lb(c, a.target, e, a.name + "." + b, d)),
          f && Object.defineProperty(a.target, b, Yc(b));
      }
      function Uc(a, b, c) {
        var d = a.name + "." + b;
        (c.name = d),
          c.scope || (c.scope = a.target),
          (a.values[b] = c),
          Object.defineProperty(a.target, b, Yc(b));
      }
      function Xc(a) {
        return (
          Vc[a] ||
      ...
      function Zc(a, b, c) {
        ...
        if (hc(d)) {
          if (
            ((f = jc(d, { type: "update", object: a, name: b, newValue: c })),
            !f)
          )
            return;
          c = f.newValue;
        }
        (c = e.prepareNewValue(c)),
          c !== bd &&
            ((g = kc(d)),
            (h = bc()),
            (f =
      ...
      function $c(a, b, c, d) {
        var e = kc(a),
          f = bc(),
          g = e || f ? { type: "add", object: b, name: c, newValue: d } : null;
        ...
        return (
          ...
          void 0 !== b
            ...
            : (jd(a),
              a.$mobx
                ? a.$mobx
                : (vd(!1, "Cannot obtain administration from " + a), void 0))
        );
      }
      function gd(a, b) {
        var c;
        return (
          (c = void 0 !== b ? ed(a, b) : ad(a) || Oc(a) ? fd(a) : ed(a)), c.name
        );
      }
      function hd(a, b, c, d, e) {
        function f(f, g, h, i, j) {
          ...
          return (
            ...
            h
              ? (Hd(f, "__mobxLazyInitializers") ||
                  Jd(
                    f,
                    "__mobxLazyInitializers",
                    (f.__mobxLazyInitializers &&
                      f.__mobxLazyInitializers.slice()) ||
                      []
                  ),
                (l = h.value),
                (m = h.initializer),
                f.__mobxLazyInitializers.push(function (b) {
                ...
                }),
                {
                  ...
                  get: function () {
                    return (
                      this.__mobxDidRunLazyInitializers !== !0 && jd(this),
                      b.call(this, g)
                    );
                  },
                  set: function (a) {
              ...
              : ((k = {
                  ...
                  get: function () {
                    return (
                      (this.__mobxInitializedProps &&
                        this.__mobxInitializedProps[g] === !0) ||
                        id(this, g, void 0, a, i, h),
                      b.call(this, g)
                    );
                  },
                  set: function (b) {
                ...
                (arguments.length < 3 || (5 === arguments.length && 3 > j)) &&
                  Object.defineProperty(f, g, k),
                k)
          );
        }
        return e
      ...
      function id(a, b, c, d, e, f) {
        Hd(a, "__mobxInitializedProps") || Jd(a, "__mobxInitializedProps", {}),
          (a.__mobxInitializedProps[b] = !0),
          d(a, b, c, e, f);
      }
      function jd(a) {
        a.__mobxDidRunLazyInitializers !== !0 &&
          a.__mobxLazyInitializers &&
          (Jd(a, "__mobxDidRunLazyInitializers", !0),
          a.__mobxDidRunLazyInitializers &&
            a.__mobxLazyInitializers.forEach(function (b) {
              return b(a);
            }));
      }
      function kd(a) {
      ...
      function nd(a) {
        vd(a[md] !== !0, "Illegal state: cannot recycle array as iterator"),
          Kd(a, md, !0);
        var b = -1;
        return (
          Kd(a, "next", function () {
      ...
      function vd(a, b, c) {
        if (!a)
          throw new Error(
            "[mobx] Invariant failed: " + b + (c ? " in '" + c + "'" : "")
          );
      }
      function xd(a) {
        return -1 !== wd.indexOf(a)
          ? !1
          : (wd.push(a), console.error("[mobx] Deprecated: " + a), !0);
      }
      function yd(a) {
        var b = !1;
        return function () {
      ...
      function Bd(a, b, c) {
        if ((void 0 === b && (b = 100), void 0 === c && (c = " - "), !a))
          return "";
        var d = a.slice(0, b);
        return (
          "" +
          d.join(c) +
          (a.length > b ? " (... and " + (a.length - b) + "more)" : "")
        );
      }
      function Cd(a) {
        return (
      ...
      function Od(a, b) {
        ...
        if (c) {
          ...
          for (f = a.length - 1; f >= 0; f--) if (!Od(a[f], b[f])) return !1;
          return !0;
        }
        if (e)
        ...
        if (
          ...
          if (Rd(a) && Rd(b))
            return a.size !== b.size
              ? !1
              : Od(Q.shallowMap(a).entries(), Q.shallowMap(b).entries());
      ...
      Object.defineProperty(b, "__esModule", { value: !0 }),
        ...
        "object" ===
          ("undefined" == typeof __MOBX_DEVTOOLS_GLOBAL_HOOK__
            ? "undefined"
            : d(__MOBX_DEVTOOLS_GLOBAL_HOOK__)) &&
          __MOBX_DEVTOOLS_GLOBAL_HOOK__.injectMobx(a.exports),
        (a.exports.default = a.exports),
        (f = hd(
          function (a, b, c, d) {
            var f =
                d && 1 === d.length ? d[0] : c.name || b || "<unnamed action>",
              g = h(f, c);
            Jd(a, b, g);
          },
          function (a) {
        ...
        (h = function (a, b) {
          return 1 === arguments.length && "function" == typeof a
            ? _(a.name || "<unnamed action>", a)
            : 2 === arguments.length && "function" == typeof b
            ? _(a, b)
            : 1 === arguments.length && "string" == typeof a
            ? i(a)
        ...
        (t = function (a, b) {
          ...
          vd("function" == typeof a, qd("m011")),
            vd(arguments.length < 3, qd("m012"));
          var e =
            "object" === ("undefined" == typeof b ? "undefined" : d(b))
              ? b
              : {};
          return (
            (e.setter = "function" == typeof b ? b : e.setter),
            new lb(
              a,
              e.context,
              e.compareStructural || e.struct || !1,
              e.name || a.name || "",
              e.setter
            )
          );
        ...
        (b.computed = t),
        (t.struct = s),
        (b.createTransformer = u),
        (b.expr = w),
        (b.extendObservable = x),
        (b.extendShallowObservable = y),
        (b.intercept = E),
        (b.isComputed = H),
        (b.isObservable = I),
        (J = S(tc)),
        ...
        (P = (function () {
          ...
          return (
            ...
            (a.prototype.shallowArray = function (a, b) {
              return (
                arguments.length > 2 && R("shallowArray"), new Dc(a, vc, b)
              );
            }),
        ...
        (b.IObservableFactories = P),
        (Q = O),
        (b.observable = Q),
        Object.keys(P.prototype).forEach(function (a) {
          return (Q[a] = P.prototype[a]);
        }),
        (Q.deep.struct = Q.struct),
        (Q.ref.struct = function () {
          return arguments.length < 2
            ? sc(xc, arguments[0])
        ...
        (ib = (function () {
          function a(a) {
            void 0 === a && (a = "Atom@" + td()),
              ...
              (this.lowestObserverState = nb.NOT_TRACKING);
          }
          return (
        ...
        (jb = (function (a) {
          function b(b, c, d) {
            ...
            return (
              (e.name = b),
              (e.onBecomeObservedHandler = c),
              (e.onBecomeUnobservedHandler = d),
        ...
        (lb = (function () {
          function a(a, b, c, d, e) {
            (this.derivation = a),
              (this.scope = b),
              (this.compareStructural = c),
              (this.dependenciesState = nb.NOT_TRACKING),
              (this.observing = []),
              ...
              (this.runId = 0),
              (this.lastAccessedBy = 0),
              (this.lowestObserverState = nb.UP_TO_DATE),
              (this.unboundDepsCount = 0),
              (this.__mapid = "#" + td()),
              (this.value = void 0),
              (this.isComputing = !1),
              (this.isRunningSetter = !1),
              (this.name = d || "ComputedValue@" + td()),
              e && (this.setter = _(d + "-setter", e));
          }
          return (
            ...
            (a.prototype.onBecomeUnobserved = function () {
              vd(this.dependenciesState !== nb.NOT_TRACKING, qd("m029")),
                vb(this),
                (this.value = void 0);
            }),
            (a.prototype.get = function () {
              vd(
                ...
                0 === Cb.inBatch
                  ? (Nb(),
                    qb(this) && (this.value = this.computeValue(!1)),
                    Ob())
                  : (Pb(this), qb(this) && this.trackAndCompute() && Sb(this));
              var a = this.value;
            ...
            (a.prototype.trackAndCompute = function () {
              ...
              return (
                ...
                (a = this.value),
                (b = this.value = this.computeValue(!0)),
                pb(b) || Fd(this.compareStructural, b, a)
              );
            }),
            ...
            (a.prototype.observe = function (a, b) {
              ...
              return m(function () {
                ...
                (!d || b) &&
                  ((g = xb()),
                  a({ type: "update", object: c, newValue: f, oldValue: e }),
                  yb(g)),
                  (d = !1),
                  (e = f);
              });
        ...
        (lb.prototype[Td()] = lb.prototype.valueOf),
        (mb = Pd("ComputedValue", lb)),
        (function (a) {
        ...
        (b.untracked = wb),
        (Ab = ["mobxGuid", "resetId", "spyListeners", "strictMode", "runId"]),
        (Bb = (function () {
          function a() {
            (this.version = 5),
          ...
          return (
              ...
              this.isDisposed ||
                ...
                qb(this) &&
                  ...
                  this._isTrackPending &&
                    bc() &&
                    cc({ object: this, type: "scheduled-reaction" })),
                Ob());
            }),
            (a.prototype.track = function (a) {
              ...
              Nb(),
                ...
                b &&
                  ((c = Date.now()),
                  dc({ object: this, type: "reaction", fn: a })),
                (this._isRunning = !0),
                (d = tb(this, a, void 0)),
                (this._isRunning = !1),
                (this._isTrackPending = !1),
                this.isDisposed && vb(this),
                pb(d) && this.reportExceptionInDerivation(d.cause),
                b && fc({ time: Date.now() - c }),
                Ob();
            }),
            (a.prototype.reportExceptionInDerivation = function (a) {
              ...
              return this.errorHandler
                ? (this.errorHandler(a, this), void 0)
                : ((c =
                  ...
                  console.error(c || d, a),
                  bc() &&
                    cc({ type: "error", message: c, error: a, object: this }),
        ...
        (Cc = (function () {
          function a(a, b, c, d) {
            (this.array = c),
              ...
              (this.atom = new ib(a || "ObservableArray@" + td())),
              (this.enhancer = function (c, d) {
                return b(c, d, a + "[..]");
              });
          }
          return (
            ...
            (a.prototype.spliceWithArray = function (a, b, c) {
              ...
              return (
                ...
                (g = c.length - b),
                this.updateArrayLength(e, g),
                (h = this.spliceItemsIntoValues(a, b, c)),
                (0 !== b || 0 !== c.length) && this.notifyArraySplice(a, c, h),
                h
              );
            }),
            (a.prototype.spliceItemsIntoValues = function (a, b, c) {
              var d, e;
              return c.length < yc
                ? (e = this.values).splice.apply(e, [a, b].concat(c))
                : ((d = this.values.slice(a, a + b)),
                  (this.values = this.values
                    .slice(0, a)
                    .concat(c, this.values.slice(a + b))),
                  d);
            }),
        ...
        (Dc = (function (a) {
          function b(b, c, d, e) {
            var f, g;
            return (
              void 0 === d && (d = "ObservableArray@" + td()),
              void 0 === e && (e = !1),
              (f = a.call(this) || this),
              (g = new Cc(d, c, f, e)),
              Kd(f, "$mobx", g),
              b && b.length
                ? (g.updateArrayLength(0, b.length),
                  (g.values = b.map(function (a) {
                    return c(a, void 0, d + "[..]");
                  })),
                  g.notifyArraySplice(0, g.values.slice(), rd))
                : (g.values = []),
              zc && Object.defineProperty(g.array, "0", Ec),
              f
            );
          }
          return (
            ...
            (b.prototype.push = function () {
              ...
              return (
                (c = this.$mobx),
                c.spliceWithArray(c.values.length, 0, a),
                c.values.length
              );
            }),
            ...
            (b.prototype.unshift = function () {
              ...
              for (b = 0; b < arguments.length; b++) a[b] = arguments[b];
              return (
                (c = this.$mobx), c.spliceWithArray(0, 0, a), c.values.length
              );
            }),
            ...
            (b.prototype.move = function (a, b) {
              function c(a) {
                if (0 > a)
                  throw new Error(
                    "[mobx.array] Index out of bounds: " + a + " is negative"
                  );
                ...
                a !== b &&
                  ...
                  (e =
                    b > a
                      ? d
                          .slice(0, a)
                          .concat(d.slice(a + 1, b + 1), [d[a]], d.slice(b + 1))
                      : d
                          .slice(0, b)
                          .concat([d[a]], d.slice(b, a), d.slice(a + 1))),
                  this.replace(e));
            }),
        ...
        Object.defineProperty(Dc.prototype, "length", {
          enumerable: !1,
          configurable: !0,
          get: function () {
        ...
        [
          ...
          vd(
            "function" == typeof b,
            "Base function not defined on Array prototype: '" + a + "'"
          ),
            Jd(Dc.prototype, a, function () {
              return (
                this.$mobx.atom.reportObserved(),
                b.apply(this.$mobx.values, arguments)
              );
            });
        }),
        (Ec = { configurable: !0, enumerable: !1, set: Gc(0), get: Hc(0) }),
        Ic(1e3),
        (Jc = Pd("ObservableArrayAdministration", Cc)),
        (b.isObservableArray = Kc),
        (Lc = {}),
        (Mc = (function () {
          function a(a, b, c) {
            void 0 === b && (b = tc),
              void 0 === c && (c = "ObservableMap@" + td()),
              (this.enhancer = b),
              (this.name = c),
              (this.$mobx = Lc),
              (this._data = {}),
              (this._hasMap = {}),
              (this._keys = new Dc(void 0, vc, this.name + ".keys()", !0)),
              (this.interceptors = null),
              (this.changeListeners = null),
              this.merge(a);
          }
          return (
            ...
            (a.prototype.has = function (a) {
              return this.isValidKey(a)
                ? ((a = "" + a),
                  this._hasMap[a]
                    ? this._hasMap[a].get()
                    : this._updateHasMapEntry(a, !1).get())
                : !1;
            }),
            ...
            (a.prototype.delete = function (a) {
              ...
              return (
                ...
                (a = "" + a),
                hc(this) &&
                ((c = jc(this, { type: "delete", object: this, name: a })), !c)
                  ? !1
                  : this._has(a)
                  ? ((d = bc()),
                    (e = kc(this)),
            ...
            (a.prototype._addValue = function (a, b) {
              ...
              Y(function () {
                ...
                (f =
                  e || d
                    ? { type: "add", object: this, name: a, newValue: b }
                    : null),
                d && dc(f),
                e && mc(this, f),
                d && fc();
              ...
              return (
                ...
                Y(function () {
                  Dd(a)
                    ...
                    : null !== a &&
                      void 0 !== a &&
                      ud("Cannot initialize map from " + a);
                }),
                this
              );
            }),
        ...
        (b.ObservableMap = Mc),
        od(Mc.prototype, function () {
          return this.entries();
        }),
        (b.map = Nc),
        (Oc = Pd("ObservableMap", Mc)),
        (b.isObservableMap = Oc),
        (Pc = (function () {
          function a(a, b) {
            (this.target = a),
              (this.name = b),
        ...
        (Vc = {}),
        (Wc = {}),
        (_c = Pd("ObservableObjectAdministration", Pc)),
        (b.isObservableObject = ad),
        (bd = {}),
        (cd = (function (a) {
          function b(b, c, d, e) {
            void 0 === d && (d = "ObservableValue@" + td()),
              void 0 === e && (e = !0);
            var f = a.call(this, d) || this;
            return (
              (f.enhancer = c),
              (f.hasUnreportedChange = !1),
              (f.value = c(b, void 0, d)),
              e && bc() && cc({ type: "create", object: f, newValue: f.value }),
              f
            );
          }
          return (
            ...
            (b.prototype.prepareNewValue = function (a) {
              if ((sb(this), hc(this))) {
                var b = jc(this, { object: this, type: "update", newValue: a });
                if (!b) return bd;
                a = b.newValue;
              }
              return (
        ...
        (cd.prototype[Td()] = cd.prototype.valueOf),
        (dd = Pd("ObservableValue", cd)),
        (b.isBoxedObservable = dd),
        (md = "__$$iterating"),
        (pd = {
  ...
  function (a, b, c) {
    ...
    function g(a, b) {
      ...
      return (
        (g.lang = "en-US"),
        (g.className = "gitment-container gitment-header-container"),
        (h = document.createElement("span")),
        (i = f.find(function (a) {
          return "heart" === a.content && a.user.login === d.login;
        })),
        (h.className = "gitment-header-like-btn"),
        (h.innerHTML =
          "\n    " +
          e.heart +
          "\n    " +
          (i ? "Unlike" : "Like") +
          "\n    " +
          (c.reactions && c.reactions.heart
            ? " • <strong>" + c.reactions.heart + "</strong> Liked"
            : "") +
          "\n  "),
        i
        ...
        (j.innerHTML =
          "\n    " +
          (c.comments
            ? " • <strong>" + c.comments + "</strong> Comments"
            : "") +
          "\n  "),
        g.appendChild(j),
        (k = document.createElement("a")),
        (k.className = "gitment-header-issue-link"),
        (k.href = c.html_url),
        (k.target = "_blank"),
        (k.innerText = "Issue Page"),
        g.appendChild(k),
        g
      );
    }
    function h(a, b) {
      ...
      if (
        ((k.lang = "en-US"),
        (k.className = "gitment-container gitment-comments-container"),
        j)
      )
        return (
          (l = document.createElement("div")),
          (l.className = "gitment-comments-error"),
          j === f.NOT_INITIALIZED_ERROR &&
          i.login &&
          i.login.toLowerCase() === b.owner.toLowerCase()
            ? ((m = document.createElement("div")),
              (n = document.createElement("button")),
              (n.className = "gitment-comments-init-btn"),
              (n.onclick = function () {
                n.setAttribute("disabled", !0),
                  b.init().catch(function (a) {
                    n.removeAttribute("disabled"), alert(a);
                  });
              }),
              (n.innerText = "Initialize Comments"),
              m.appendChild(n),
              l.appendChild(m))
            : (l.innerText = j),
          k.appendChild(l),
      ...
      if (void 0 === d)
        return (
          ...
          (o.innerText = "Loading comments..."),
          (o.className = "gitment-comments-loading"),
          k.appendChild(o),
          k
        );
      if (!d.length)
        return (
          ...
          (p.className = "gitment-comments-empty"),
          (p.innerText = "No Comment Yet"),
          k.appendChild(p),
          k
        );
      if (
        ((q = document.createElement("ul")),
        (q.className = "gitment-comments-list"),
        d.forEach(function (a) {
          ...
          (f.className = "gitment-comment"),
            (f.innerHTML =
              ...
              a.body_html +
              "</div>\n      </div>\n    "),
            (h = f.querySelector(".gitment-comment-like-btn")),
            (j =
              g[a.id] &&
              g[a.id].find(function (a) {
            ...
            (l = f.querySelector(".gitment-comment-body")),
            (k.className = "gitment-hidden"),
            (k.src =
              "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="),
            (k.onload = function () {
              l.clientHeight > b.maxCommentHeight &&
                (l.classList.add("gitment-comment-body-folded"),
                (l.style.maxHeight = b.maxCommentHeight + "px"),
        ...
        k.appendChild(q),
        c && ((r = Math.ceil(c.comments / b.perPage)), r > 1))
      ) {
        for (
          s = document.createElement("ul"),
            s.className = "gitment-comments-pagination",
            h > 1 &&
              ((t = document.createElement("li")),
              (t.className = "gitment-comments-page-item"),
              (t.innerText = "Previous"),
              (t.onclick = function () {
                return b.goto(h - 1);
              }),
              s.appendChild(t)),
            u = function (a) {
              ...
              (c.className = "gitment-comments-page-item"),
                (c.innerText = a),
                (c.onclick = function () {
                  return b.goto(a);
                }),
                h === a && c.classList.add("gitment-selected"),
                s.appendChild(c);
            },
            v = 1;
          r >= v;
    ...
    function i(a, b) {
      ...
      return (
        (g.lang = "en-US"),
        (g.className = "gitment-container gitment-editor-container"),
        (h = c.login && !f ? "" : "disabled"),
        (i = c.login ? "" : "Login to Comment"),
        (g.innerHTML =
          "\n      " +
          (c.login
            ? '<a class="gitment-editor-avatar" href="' +
              ...
              '"/>\n          </a>'
            : c.isLoggingIn
            ? '<div class="gitment-editor-avatar">' + e.spinner + "</div>"
            : '<a class="gitment-editor-avatar" href="' +
              b.loginLink +
          ...
          ">Comment</button>\n    </div>\n  "),
        c.login &&
          (g.querySelector(".gitment-editor-logout-link").onclick =
            function () {
              return b.logout();
            }),
        (j = g.querySelector(".gitment-editor-write-field")),
        (k = g.querySelector(".gitment-editor-preview-field")),
        (l = j.querySelector("textarea")),
        (l.oninput = function () {
          var a, b, c, d;
          (l.style.height = "auto"),
            (a = window.getComputedStyle(l, null)),
            (b = parseInt(a.height, 10)),
            (c = l.clientHeight),
            (d = l.scrollHeight),
            d > c && (l.style.height = b + d - c + "px");
        }),
        (m = g.querySelectorAll(".gitment-editor-tab")),
        (n = d(m, 2)),
        (o = n[0]),
        (p = n[1]),
        (o.onclick = function () {
          o.classList.add("gitment-selected"),
            p.classList.remove("gitment-selected"),
            j.classList.remove("gitment-hidden"),
            k.classList.add("gitment-hidden"),
            l.focus();
        }),
        (p.onclick = function () {
          var a, c;
          return (
            ...
            o.classList.remove("gitment-selected"),
            k.classList.remove("gitment-hidden"),
            j.classList.add("gitment-hidden"),
            (a = k.querySelector(".gitment-editor-preview")),
            (c = l.value.trim())
              ? ((a.innerText = "Loading preview..."),
                b.markdown(c).then(function (b) {
                  return (a.innerHTML = b);
                }),
                void 0)
              : ((a.innerText = "Nothing to preview"), void 0)
          );
        }),
        (q = g.querySelector(".gitment-editor-submit")),
        (q.onclick = function () {
          (q.innerText = "Submitting..."),
    ...
    function j() {
      ...
      return (
        (a.lang = "en-US"),
        (a.className = "gitment-container gitment-footer-container"),
        (a.innerHTML =
    ...
    function k(a, b) {
      ...
      return (
        (c.lang = "en-US"),
        (c.className = "gitment-container gitment-root-container"),
        c.appendChild(b.renderHeader(a, b)),
        c.appendChild(b.renderComments(a, b)),
        c.appendChild(b.renderEditor(a, b)),
        c.appendChild(b.renderFooter(a, b)),
        c
      );
    }
    var d, e, f;
  ...
  function (a, b, c) {
    ...
    function i(a) {
      return function (b) {
        var k,
          ...
          j = null;
        return (
          ("GET" === a || "DELETE" === a) && (i += h.stringify(c)),
          (k = new Promise(function (a, b) {
            f.addEventListener("load", function () {
              var e,
                c = f.getResponseHeader("content-type"),
                d = f.responseText;
              return /json/.test(c)
                ? ((e = f.responseText ? JSON.parse(d) : {}),
                  e.message ? b(new Error(e.message)) : a(e),
                  void 0)
                : (a(d), void 0);
            }),
          ...
          g && f.setRequestHeader("Authorization", "token " + g),
          "GET" !== a &&
            "DELETE" !== a &&
            ((j = JSON.stringify(c)),
    ...
    var d, e, f, h;
    Object.defineProperty(b, "__esModule", { value: !0 }),
      (b.http = b.Query = b.isString = void 0),
      (d = (function () {
        function a(a, b) {
          var h,
            g,
          ...
          var d,
            ...
            c =
              arguments.length > 0 && void 0 !== arguments[0]
                ...
                : {};
          k(this, a),
            (this.defaultTheme = i.default),
            this.useTheme(i.default),
            Object.assign(
              this,
              {
            ...
            (d = {});
          try {
            (h = localStorage.getItem(f.LS_USER_KEY)),
              this.accessToken &&
                h &&
                Object.assign(d, JSON.parse(h), { fromCache: !0 });
          } catch (j) {
          ...
          (this.state = e.observable({
            ...
            l.code
              ? ((m = this.oauth),
                ...
                Object.assign(this, { id: r, link: r }, c),
                (this.state.user.isLoggingIn = !0),
                g.http
                  .post(
                    "https://gh-oauth.imsun.net",
                    { code: p, client_id: n, client_secret: o },
                    ""
                  )
                  .then(function (a) {
        ...
        return (
            ...
            },
            {
              ...
              get: function () {
                var a = "https://github.com/login/oauth/authorize",
                  ...
                  c = Object.assign({ scope: l, redirect_uri: b }, this.oauth);
          ...
          d(a, [
            ...
            },
            {
              key: "markdown",
              value: function (a) {
                return g.http.post("/markdown", { text: a, mode: "gfm" });
              },
            },
            {
              key: "createIssue",
            ...
            },
            {
              ...
              value: function (a) {
                ...
                return this.getIssue()
                  .then(function (b) {
                    return g.http.post(b.comments_url, { body: a }, "");
                  })
                  .then(function (a) {
                    b.state.meta.comments++;
                    var c = Math.ceil(b.state.meta.comments / b.perPage);
                    return (
                      b.state.currentPage === c && b.state.comments.push(a), a
                    );
                  });
              },
            },
            {
              ...
              value: function () {
                var a = this,
                  ...
                  d = this.repo;
                return g.http
                  .get("/repos/" + c + "/" + d + "/issues", {
                    creator: c,
                    labels: b,
                  })
                  .then(function (b) {
                    return b.length
                      ? ((a.state.meta = b[0]), b[0])
                      : Promise.reject(f.NOT_INITIALIZED_ERROR);
                  });
              },
            },
            {
            ...
            },
            {
              ...
              value: function () {
                ...
                return this.accessToken
                  ? g.http.get("/user").then(function (b) {
                      return (
                        (a.state.user = b),
                        localStorage.setItem(f.LS_USER_KEY, JSON.stringify(b)),
                        b
                      );
                    })
            ...
            },
            {
              ...
              value: function () {
                ...
                return this.accessToken
                  ? this.getIssue()
                      .then(function (a) {
                        return a.reactions.total_count
                          ? g.http.get(a.reactions.url, {}, "")
                          : [];
                      })
                      .then(function (b) {
            ...
            },
            {
              key: "logout",
              value: function () {
                localStorage.removeItem(f.LS_ACCESS_TOKEN_KEY),
                  localStorage.removeItem(f.LS_USER_KEY),
                  (this.state.user = {});
              },
            },
                ...
                return this.accessToken
                  ? ((b = this.owner),
                    ...
                    g.http
                      ...
                      .then(function (b) {
                        a.state.reactions.push(b),
                          a.state.meta.reactions.heart++;
                      }))
            ...
            },
            {
              ...
              value: function (a) {
                ...
                return this.accessToken
                  ? ((c = this.owner),
                    (d = this.repo),
                    (e = this.state.comments.find(function (b) {
                      return b.id === a;
                    })),
                    g.http
                      .post(
                      ...
                      .then(function (c) {
                        b.state.commentReactions[a].push(c),
                          e.reactions.heart++;
                      }))
                  : (alert("Login to Like"), Promise.reject());
              },
            },
            {
              ...
              value: function (a) {
                var b, c, d, e;
                return this.accessToken
                  ? ((b = this.state.commentReactions[a]),
                    (c = this.state.comments.find(function (b) {
                      return b.id === a;
                    })),
                    (d = this.state.user),
